...
export class QueryEditor extends PureComponent<Props> {
  render() {
    ...
    return (
      <Card
        heading='Alert'
        description='This datasource is only intended to be used for variable queries.'>
          <Card.Figure>
            <Icon name='exclamation-triangle' size='xl'/>
          </Card.Figure>
          <Card.Actions>
            <a target='_blank' href='https://grafana.com/docs/grafana/latest/variables/variable-types/add-query-variable/'>
